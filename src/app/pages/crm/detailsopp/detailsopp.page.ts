...
export class DetailsoppPage implements OnInit {
  ...
  constructor(private contactservice:ContactService,private alertCtrl :AlertController,private composer :EmailComposer,private loadingCtrl:LoadingController,private toastCtrl: ToastController,private modalCtrl :ModalController,private oppservice :OppService ,private actionSheetController :ActionSheetController) { 
  ...
  this.oppdet = value ; 
        ...
        if(!isUndefined(this.oppdet.datecreation) || !isNull(this.oppdet.datecreation) ){
         this.datecr = this.oppdet.datecreation.toString().substr(0,10)}
