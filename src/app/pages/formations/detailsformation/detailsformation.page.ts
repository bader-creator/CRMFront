...
search:string
  ...
  constructor(private formationservice:Formationservice,private  alertctrl:AlertController  ,public modalController:ModalController ,public navctrl : NavController  ,public toastCtrl: ToastController,
